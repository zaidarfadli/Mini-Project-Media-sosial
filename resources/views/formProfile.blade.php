        ...
        <form action="{{ route('ubahProfile') }}" method="post">
            ...
            <div class="mb-3">
                <label for="form-Name" class="form-label"
                    class=" @error('name') is-invalid border-danger @enderror">Name</label>
                <input type="text" name="name" class="form-control" id="form-Name"
                    value="{{ old('name', $user->name) }}" placeholder="Iamge Link">
                @error('name')
            ...
            <div class="mb-3">
                <label for="form-username" class="form-label"
                    class=" @error('username') is-invalid border-danger @enderror">username </label>
            ...
            <div class="mb-3">
                <label for="form-bio" class="form-label" class=" @error('bio') is-invalid border-danger @enderror">bio
                </label>
