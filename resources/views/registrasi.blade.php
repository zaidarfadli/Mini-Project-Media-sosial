                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row row_input1">
                                                <div class="col-md-6">
                                                    <h6>Username</h6>
                                                    <input type="text" class="@error('username') is-invalid border-danger @enderror" name="username" id="usernameRegist" value="{{ old('username') }}" placeholder="Masukkan username">
                                                    @error('username')
                                                ...
                                                <div class="col-md-6 namaRegist">
                                                    <h6>Nama</h6>
                                                    <input type="text"  class="@error('name') is-invalid border-danger @enderror" name="name" id="namaRegist" value="{{ old('name') }}" placeholder="Masukkan nama lengkap">
                                                    @error('name')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="row row_input2">
                                                <h6>E - Mail</h6>
                                                <input type="text" class="@error('email') is-invalid border-danger @enderror"  name="email" id="emailRegist" value="{{ old('email') }}" placeholder="Masukkan akun e-mail">
                                                @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="row row_input2">
                                                <h6>Password</h6>
                                                <input type="password"  class="@error('password') is-invalid border-danger @enderror"   name="password" id="passwordRegist" placeholder="Masukkan password">
                                                @error('password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
