                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row row_input1">
                                                ...
                                                <h6>Username</h6>
                                                <input type="text" name="username" class=" @error('username') is-invalid border-danger @enderror" id="username" placeholder="Masukkan username">
                                                @error('username')
                                            ...
                                            <div class="row row_input2">
                                                <h6>Password</h6>
                                                <input type="password"  class=" @error('username') is-invalid border-danger @enderror" name="password" id="password" placeholder="Masukkan password">
                                                @error('password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="col-md-9">
                                <div class="row" style="display: flex; align-items: center;">
                                    <div class="col-md-1"
                                        ...
                                        <img src="{{ asset('images/logo-medsos.png') }}" alt="image-logo" style="width: 50px;">
                                    </div>
