                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        @if (Route::currentRouteName() == 'myProfile')
                            <a href="{{ route('formConfirmPassword') }}" class="btn btn-primary">Ubah Profil</a>
                        @endif
                    ...
                    <div class="col">
                        ...
                        <h5>{{ $user->name }}</h5>
                        <p>{{ $user->bio }}</p>
                        <p><a href="{{ route('seeFollower',['user' => $user->id]) }}">Followers = {{ $user->followerCount() }}</a></p>
                        <p><a href="{{ route('seeFollowing',['user' => $user->id]) }}">Following = {{ $user->followingCount() }}</a></p>
