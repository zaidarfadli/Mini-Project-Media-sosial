            ...
            <div class="container-fluid container-xl">
                <div class="row">
                        ...
                        <div class="row navigasiFilter">
                            <ul class="navigasi" style="margin-top: 10px; margin-bottom: -20px;">
                                <li class="navigasi-item NavFilter">
                                    <a class="navigasi-link pilihKategoriFollow active" href="{{ route('seeFollower',['people' => $people->id]) }}">
                                        <p>Followers</p>
                                    </a>
                                </li>
                                <li class="navigasi-item">
                                    <a class="navigasi-link pilihKategoriFollow" href="{{ route('seeFollowing',['people' => $people->id]) }}">
                                        <p>Following</p>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-6 listFollowers">
                        ...
                        <a href="{{ route('seeProfile',['user' => $follow->id])  }}" style="display: flex;">
                            ...
                            @if ($follow->id != $user->id)
                                ...
                                @else
                                    <form action="{{ route('follow',['people' => $follow->id]) }}" method="POST">
                                        ...
                                        <p>
                                            <button type="submit" class="btn">{{ $follow->is_follow ? 'Unfollow' : 'Follow' }}</button>
                                        </p>
                                    </form>
                                @endif
                            @else
