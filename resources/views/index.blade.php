    ...
    <div class="sidebar">
        <div class="detail_logo">
            <a href="{{ route('myProfile') }}" style="display: flex;">
                ...
                @else
                <i><img src="{{ asset('images/no_image.png') }}" alt="gambar postingan"></i>
                <div class="container-fluid rowUsername">
                    <div class="row">
                        <span id="usernameProfileAuthor">Silahkan Login Dahulu</span>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <ul class="navigasi" style="margin-top: 10px; margin-bottom: 0;">
                            <li class="navigasi-item NavFilter">
                                <a class="navigasi-link pilihKategoriPostingan active" href="{{ route('home') }}">
                                    <p>For You</p>
                                </a>
                            </li>
                            <li class="navigasi-item">
                                <a class="navigasi-link pilihKategoriPostingan" href="{{ route('home2') }}">
                                    <p>Following</p>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="container container-lg">
                            ...
                            <a href="{{ route('seePost',['post' => $post->id]) }}" style="text-decoration: none; color: black;">
                                                    ...
                                                    <div class="card mx-auto">
                                                        <div class="card-body cardContent">
                                                            <div class="profileAuthor">
                                                                <a href="{{ route('seeProfile',['user' => $post->user->id]) }}" style="display: flex; text-decoration: none;">
                                                                    <img class="imagesProfileAuthorPost" src="{{ asset('images/profile/'. $post->user->image) }}" alt="gambar profile">
                                                                    <div class="container" style="margin: 0rem 0rem 0rem -1.2rem;">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p id="UsernamePosting">{{ $post->user->username }}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <p id="timePosting">{{ $post->created_at->diffForHumans() }}</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                        ...
                                                        <img style="border-radius: 8px;" src="{{ $post->image }}" class="card-img-top" alt="Gambar Postingan">
                                                        ...
                                                        <div class="container fiturPostingan d-flex" style="margin-left: -4rem; font-size: 1rem;">
                                                            <form action="{{ route('likePost',['post' => $post->id]) }}" method="post">
                                                                ...
                                                                <button type="submit" class="btn btn-unstyled"><i class="fa-solid fa-heart"></i></button>
                                                                @else
                                                                    <button type="submit" class="btn btn-unstyled"><i class="fa-regular fa-heart"></i></button>
                                                                @endif
                                                            </form>
                    ...
                    <div class="col-3">
                        <div class="row" style="position: fixed; max-width: 20rem; margin-left: -3rem;">
                            <div class="col-12" id="SuggestFollowing">
                                <div class="container" style="height: 50rem; width: 120%; margin-left: -3rem; border: 1px solid var(--main_color-2); border-radius: 10px;">
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row" style="max-height: 7rem; margin-bottom: 0.7rem;">
                                        <div class="row">
                                            <a href="{{ route('seeProfile',['user' => $people->id]) }}" style="text-decoration: none; display:flex; color: black;">
                                                <div class="col-1">
                                                    <i><img src="{{ asset('images/profile/'.$people->image) }}" alt="gambar postingan" style="width: 2.8rem; aspect-ratio: 1/1; background-color: white; border-radius: 50%;"></i>
                                                </div>
                                                <div class="col-9" style="margin-top: 4px;">
                                                    <div class="container" style="margin-left: 1rem;">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <p style="font-weight: 700; margin-bottom: 2px; color: white; font-size: 0.8rem;" class="suggestedFollowing">
                                                                   {{$people->username}}
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <p style="font-weight: 400; margin-top: -2px; color: white; font-size: 0.5rem;" class="suggestedFollowing">
                                                                    {{ $people->name }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-3">
                                                    <form action="{{ route('follow',['people' => $people->id]) }}" method="POST">
                                                        ...
                                                        <p>
                                                            @if ($people->is_follow)
                                                            <button type="submit" class="btn" style="font-weight: 700; margin-top: 7px; font-size: 0.7rem; color: var(--main_color); ">Unfollow</button>
                                                            @else
                                                            <button type="submit" class="btn" style="font-weight: 700; margin-top: 7px; font-size: 0.7rem; color: var(--main_color); ">Follow</button>
                                                            @endif
